...
\title{Hazard Analysis for self driving car system}
...
% https://github.com/kaizen-nagoya/hazop/tree/master/Do/Readme.md

% no \IEEEPARstart
% You must have at least 2 lines in the paragraph with the drop letter
% (should never be an issue)

\subsection{What is HAZOP}
...
Some answer indicate IEC 61882\cite{HAZOP} and others indicate wikipedia\cite{wikipedia}.
...
There are 3 good points.
1st point is  focusing on "guide word".

Guide word driven risk identification lies at the heart of HAZOP study.
% https://github.com/kaizen-nagoya/English_Japanese/blob/master/Phrase/at_the_heart_of.md
In other words, HAZOP is a guid word driven brainstorming at risk identification.
% https://github.com/kaizen-nagoya/hazop/blob/master/reference/guided_brainstorming.md
...
Space guide words are "more", "less", "as well as" and "part of".
Time guide words are "early", "late", "before" and "after".
Each guide word has a opposite pair, more and less,  "as well as" and "part of", early and late, and before and after.
more and less and early and late are quantitive.
 


Using TRIZ, guided brainstorming(tm) is popular in the manufacturing industry.
% https://github.com/kaizen-nagoya/hazop/blob/master/reference/triz.md

2nd point is risk identification.
Risk handle not only negative issue, but also positive issue.
Safety analysis should include negative and positive.

3rd point is "structued and systematic".
The structure represents static and the system represents dynamic.

Wikipedia at Nov. 20, 2019 
...
There are 3 good points. 
1st point is structured and systematic. same as  IEC HAZOP.

From his, we can see HAZOP can handle static issue and dynamic issue.
2nd point is planned or existing.
Planned is not yet 

3rd point is personnel or equipment.
Hazop may be used focusing on only equipment.
On a chemical plant, analysis target may be magnetic valves and their controllers.
It is not good, because equipment is a part of system. 
Other many components of system should be considered.
if an operator can control directly the system, analysis target should include the operator.
If a control program can be changed by a programmer, analysis target should include the programmer.
If an information of the system has an error, analysis target should include all information of the system. 
If an organization decide the operation process of the system, analysis target should include the process and organization.





\subsection{TRIZ and HAZOP}
The difference with TRIZ and HAZOP is complexity.
TIRZ define many guide words such as 40 inventive principles.
HAZOP guide word is
...
\section{Self Driving car system}

Self Driving car system include many system such as self driving car system, car navigation system, traffic signal system, Automatic road enforcement, 
street lamp, guide system, and  
...
\bibitem{HAZOP} IEC 61882: Hazard and operability studies (HAZOP studies) - application guide, IEC, 2016

\bibitem{wikipedia}  http://wikipedia.org/HAZOP/
%UML proposal to the Object Management Group, Version 1.3, 1998.

%UML proposal to the Object management group, Version 1.4, 2000.
...
\bibitem  J. Guiochet, G. Motet, C. Baron, and G. Boy. Toward a human-centered UML for risk analysis. In In WCC 18th IFIP World Computer Congress, Human Error Safety and System Development, 2004.
